...
class ECG_D(nn.Module):
    ...
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16):
        ...
        self.P = Partial_conv3(nOut, 4, 'split_cat')
...
class ECG_R(nn.Module):
    def __init__(self, nIn, nOut, dilation_rate=2, reduction=16, add=True):
        ...
        self.P = Partial_conv3(nIn + n, 4, 'split_cat')
...
class SCA(nn.Module):
    def __init__(self, inchannel, outchannel):
        ...
        self.conv = nn.Sequential(
            ...
            # ChannelWiseDilatedConv(inchannel//16, inchannel//16, 7), #3, 1, dilation_rate  #ChannelWiseDilatedConv(inchannel//16, inchannel//16, 7),
            ChannelWiseDilatedConv(inchannel // 16, inchannel // 16, 3),
...
class PELANetlv3(nn.Module):
    ...
    def __init__(self, classes=19, M=2, N=6, dropout_flag=False):
        ...
        dilation_block = [4, 4, 4, 4, 4, 4, 8, 8, 8, 8, 8]
